...
insert into LPU_MOVIE_MOVIE(movie_Id,movie_Name,hero,heroine,language,director,genre,active_status) values(1001,'Bahubali','Prabhas','Anushka','Telugu','S S Rajamouli','Periodic',1);
insert into LPU_MOVIE_MOVIE(movie_Id,movie_Name,hero,heroine,language,director,genre,active_status) values(1002,'War','Hrithik Roshan','Vani Kapoor','Hindi','Karan','Action',1);
insert into LPU_MOVIE_MOVIE(movie_Id,movie_Name,hero,heroine,language,director,genre,active_status) values(1003,'KGF','Yash','Rashmi Desai','Kannada','Prashanth Neol','Action',1);
insert into LPU_MOVIE_MOVIE(movie_Id,movie_Name,hero,heroine,language,director,genre,active_status) values(1004,'World Famous Lover','Vijay Devarakoda','Rashi Kanna','Telugu','Karthikeya','Romantic',1);
insert into LPU_MOVIE_MOVIE(movie_Id,movie_Name,hero,heroine,language,director,genre,active_status) values(1005,'Hit','Viswak Sen','Pooja','Telugu','Sudheer','Thriller',1);
insert into LPU_MOVIE_MOVIE(movie_Id,movie_Name,hero,heroine,language,director,genre,active_status) values(1006,'Bahubali 2','Prabhas','Anushka','Telugu','S S Rajamouli','Periodic',1);
insert into LPU_MOVIE_MOVIE(movie_Id,movie_Name,hero,heroine,language,director,genre,active_status) values(1007,'Avengers EndGame','Robert Downey','Anne Baker','English','Russou Brothers','SciFi',1);
insert into LPU_MOVIE_MOVIE(movie_Id,movie_Name,hero,heroine,language,director,genre,active_status) values(1008,'KGF 2','Yash','Rashmi Desai','Kannada','Prashanth Neol','Action',1);
insert into LPU_MOVIE_MOVIE(movie_Id,movie_Name,hero,heroine,language,director,genre,active_status) values(1009,'Wonder Woman','Gal Gadot','Chris Pine','English','Dc World','SciFi',1);
insert into LPU_MOVIE_MOVIE(movie_Id,movie_Name,hero,heroine,language,director,genre,active_status) values(1010,'Majili','Nani','Surabhi','Telugu','Venky K','Romantic',1);
